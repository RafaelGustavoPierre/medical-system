...
INSERT INTO exam_registred (patient_id , exam_id, price, start_time, end_time, worker_id) VALUES (1, 1, 189.99, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 5);
INSERT INTO exam_registred (patient_id , exam_id, price, start_time, end_time, worker_id) VALUES (2, 2, 249.98, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 5);
