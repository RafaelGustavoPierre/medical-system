...
public class ExamRegisteredResource {
    ...
    @GetMapping("/{examId}")
    public ExamRegistred findExamRegisteredById(@PathVariable Long examId) {
        return examRegisteredService.findExamRegisteredById(examId);
    }
